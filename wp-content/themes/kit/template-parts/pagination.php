 ...
 *
 * @link https://developer..org/themes/basics/template-files/#template-partials
 *
 * @package 
 * @subpackage Kit
 * @since Kit 1.0
...
if ( $posts_pagination ) { ?>
	...
	<div class="pagination-wrapper section-inner">
		...
		<?php echo $posts_pagination; // phpcs:ignore .Security.EscapeOutput.OutputNotEscaped -- already escaped during generation. ?>
