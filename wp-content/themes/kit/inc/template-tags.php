...
function kit_site_logo( $args = array(), $display = true ) {
	...
	echo $html; // phpcs:ignore .Security.EscapeOutput.OutputNotEscaped
...
function kit_the_post_meta( $post_id = null, $location = 'single-top' ) {
	...
	echo kit_get_post_meta( $post_id, $location ); // phpcs:ignore .Security.EscapeOutput.OutputNotEscaped -- Escaped in kit_get_post_meta().
 ...
 * @since Kit 1.0
 *
 * @see wp_unique_id() Themes requiring  5.0.3 and greater should use this instead.
 *
