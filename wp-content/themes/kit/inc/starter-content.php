 ...
 * Kit Starter Content
 *
 * @link https://make..org/core/2016/11/30/starter-content-for-themes-in-4-7/
 *
 * @package 
 * @subpackage Kit
 * @since Kit 1.0
			...
			'front' => array(
				...
				'post_content' => implode(
					...
					array(
						...
						'<div class="wp-block-button is-style-outline"><a class="wp-block-button__link" href="https://make..org/core/2019/09/27/block-editor-theme-related-updates-in--5-3/">' . __( 'Read More', 'kit' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						'<!-- /wp:group -->',
						'<!-- wp:group -->',
						'<div class="wp-block-group"><div class="wp-block-group__inner-container">',
						...
						'<div class="wp-block-button aligncenter"><a class="wp-block-button__link" href="https://make..org/core/2019/09/27/block-editor-theme-related-updates-in--5-3/">' . __( 'Join the Club', 'kit' ) . '</a></div>',
						'<!-- /wp:button --></div></div>',
						'<!-- /wp:group --></div></div>',
						'<!-- /wp:group -->',
